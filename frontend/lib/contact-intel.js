...
export function fallbackOutreachDrafts({ lead, app }) {
  const firstName = lead.name && lead.name !== 'Recruiting contact'
    ...
    : 'there';
  return {
    linkedinConnectionNote: `Hi ${firstName}, I came across ${app.company}'s ${app.jobTitle} role and liked how it connects with the practical software, data, and technical problem-solving work I have been building. I would be glad to connect and follow the team's work.`,
    linkedinFollowUp: `Thanks for connecting, ${firstName}. I am exploring the ${app.jobTitle} role at ${app.company} because it connects with the kind of practical technology work I have been building across software, data/ML, QA, and user-facing systems. If you are open to it, I would enjoy hearing what makes someone thrive on the team.`,
    coldEmailSubject: `${app.jobTitle} at ${app.company}`,
    coldEmailBody: `Hi ${firstName},\n\nI came across the ${app.jobTitle} role at ${app.company} and wanted to reach out directly. The role stood out because it connects with the kind of practical technology work I have been building across React/TypeScript, Python/FastAPI, C#, SQL, data/ML projects, testing, and user-facing systems.\n\nI am graduating from Conestoga's Bachelor of Computer Science program in August 2026 and am looking for teams where I can contribute carefully, learn quickly, and build useful software. If you are close to this team, I would be grateful for any perspective on what the team values in strong early-career candidates.\n\nBest,\nGirish Bhuteja`,
  };
}
